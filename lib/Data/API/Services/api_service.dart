...
class ApiService {
  ...
  static Future<dynamic> get({required String endPoint,Map<String,String>? headers,Map<String,dynamic>? queryParams}) async {
    ...
    http.Response response = await http.get(url.replace(queryParameters: queryParameters),headers: headers,);
