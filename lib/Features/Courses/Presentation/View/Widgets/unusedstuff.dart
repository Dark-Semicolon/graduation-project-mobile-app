...
// class MyAccordionListView extends StatelessWidget {
//   const MyAccordionListView({super.key});
//
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
...
//         child: ListView(
//           children: [
//             const SizedBox(height: 20.0), // Add some spacing at the top
//             AccordionSection(
//               header: const Text(
//                 'Section 1',
...
//                 child: const Center(child: Text('Content for Section 1')),
//               ),
//               isOpen: false,
//               onOpenSection: () {
//                 print('Section 1 opened');
//               },
//               onCloseSection: () {
//                 print('Section 1 closed');
//               },
//             ),
...
//                 child: const Center(child: Text('Content for Section 2')),
//               ),
//               isOpen: false,
//               onOpenSection: () {
//                 print('Section 2 opened');
//               },
//               onCloseSection: () {
//                 print('Section 2 closed');
//               },
//             ),
//             const SizedBox(height: 20.0), // Add some spacing between sections
//             AccordionSection(
...
//                 child: const Center(child: Text('Content for Section 3')),
//               ),
//               isOpen: false,
//               onOpenSection: () {
//                 print('Section 3 opened');
//               },
//               onCloseSection: () {
//                 print('Section 3 closed');
//               },
//             ),
//             const SizedBox(height: 20.0), // Add some spacing at the bottom
//           ],
//         ),
//       ),
//     );
