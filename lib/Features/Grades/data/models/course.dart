...
class Course{
  ...
  factory Course.fromJson(json){
    return Course(type: json['type'], id: json['id'], courseAttributes:CourseAttributes.fromJson(json['attributes']));
  }
}
...
class CourseAttributes{
  ...
  factory CourseAttributes.fromJson(json){
    return CourseAttributes(name: json['name'], creditHours: json['creditHours']);
  }
