...
class Course{
  ...
  factory Course.fromJson(json){
    return Course(type:json['type'] ?? 'null',id:json['id'] ?? 0,courseAttributes:json['attributes']==null ? null :CourseAttributes.fromJson(json['attributes']), );
  }
}
...
class CourseAttributes{
  ...
  factory CourseAttributes.fromJson(json){
    return CourseAttributes(name: json['name'] ?? 'null' , creditHours: json['creditHours'] ?? 0);
  }
